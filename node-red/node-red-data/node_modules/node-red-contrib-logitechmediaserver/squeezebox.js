var squeezenode  = require('squeezenode-auth');
...
module.exports = function(RED) {
    ...
    function  squeezebox_server(config){ 
		...
		this.username = config.port;
		this.password = config.port;
		this.server = null;
		var node = this;
		...
		this.initialize_squeezebox_connection = function(){
			if (node.server){
				...
				node.server = new squeezenode(node.host, node.port, node.username, node.password);
			}
			return node.server;
		};
